...
Соответственно:
<ul>
<em>m</em> - масса объекта
<em>x</em> - координата x объекта
<em>y</em> - координата y объекта
<em>vx</em> - проекция скорости объекта на ось x
<em>vy</em> - проекция скорости объекта на ось y
<em>ax</em> - проекция ускорения на ось x
<em>ay</em> - проекция ускорения на ось y
 </ul>
